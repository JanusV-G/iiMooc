                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">资料</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
...
<%--                            </button>--%>
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <c:forEach items="${Learning_materials }" var="Learning_materials">
                                        <tr>
                                            <th><input name="chk" type="checkbox" value="${Learning_materials.lm_id }"
                                                       id="chk" class="chk"/></th>
                                            <td>${Learning_materials.lm_name }</td>
                                            <td>${Learning_materials.lesson_name }</td>
                                            <td><img src="<%=picPath%>${Learning_materials.lm_file }"
                                                     width="30px" height="30px"/></td>
                                            <td>${Learning_materials.lm_description }</td>
                                            <td>${Learning_materials.lm_create_time }</td>
                                            <td>
                                                <a href="<%=dataPath%>${Learning_materials.lm_file}" download="${Learning_materials.lm_file}">下载</a>
<%--                                                <input type="button" onclick="location.href='<%=dataPath%>${Learning_materials.file}'" value="下载">--%>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
