                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">修改资料信息</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <!-- Default box -->
             ...
             <!-- general form elements disabled -->
                        <div class="card card-warning">                      
                            <!-- /.card-header -->
                            <div class="card-body">
              <form action="<%=basePath%>Learning_materialsServlet?method=updatematerial&Lm_id=${Learning_materials.lm_id }" method="post" enctype="multipart/form-data">
                <label>资料名称：</label> 
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="请输入资料名称" name="Lm_name" value="${Learning_materials.lm_name }">
                    <div class="input-group-append">
                ...
                <label>资料上传：</label>  
                <div class="input-group mb-3">                         
                    <input type="file" class="form-control" name="Lm_file" value="">
                    <input type="hidden" value="${Learning_materials.lm_file }" name="oldpic"/>
                    <div class="input-group-append">
                        <div class="input-group-text">
                ...
                <label>资料描述：</label>  
                 <div class="input-group mb-3">                         
                    <textarea cols="50" rows="5" name="Lm_description" value="">${Learning_materials.lm_description }</textarea>
                    <div class="input-group-append">
                    </div>
                </div>
                <label>修改时间：</label> 
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="资料上传时间（yyyy-mm-dd）" name="Lm_create_time" value="${Learning_materials.lm_create_time }">
                    <div class="input-group-append">
                        <div class="input-group-text">
