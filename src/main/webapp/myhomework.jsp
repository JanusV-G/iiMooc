                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">我的作业</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
              ...
              <button type="button" class="btn btn-block btn-success" onclick="batchDelete()">
    		   <ion-icon name="trash-outline"></ion-icon>
				 ...
				 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <c:forEach items="${Homework_teacher }" var="Homework_teacher"> 
                  	<tr>
                  	 <th><input name="chk" type="checkbox" value="${Homework_teacher.homework_id }"  id="chk" class="chk"/></th>
                    <td>${Homework_teacher.homework_name }</td>
                    <td>${Homework_teacher.lesson_name }</td>
                    <td>
                    <a href="http://localhost:8080/image/${Homework_teacher.homework_file }" width="30px" height="30px"/>查看文件</a>
                    </td>
                    <td>${Homework_teacher.homework_description }</td>
                    <td>${Homework_teacher.homework_create_time }</td>
                    <td>
                    <a href="<%=basePath%>Homework_teacherServlet?method=updateToShow&homework_id=${Homework_teacher.homework_id }">修改</a>
                    </td>
                  </tr>
                  </c:forEach> 
                 </tbody>
                ...
                <div class="card-footer">
                    <nav aria-label="Contacts Page Navigation">
                         <ul class="pagination justify-content-center m-0">
                            <li class="page-item active"><a href="<%=basePath%>Learning_materialsServlet?method=findmaterial&currentPage=1">首页&nbsp&nbsp</a></li>
                            <li class="page-item"><a href="<%=basePath%>Learning_materialsServlet?method=findmaterial&currentPage=${tool.prePage }">上一页&nbsp&nbsp</a></li>
                            <li class="page-item"><a href="<%=basePath%>Learning_materialsServlet?method=findmaterial&currentPage=${tool.nextPage }">下一页&nbsp&nbsp</a></li>
                            <li class="page-item"><a href="<%=basePath%>Learning_materialsServlet?method=findmaterial&currentPage=${tool.totalPages }">尾页&nbsp&nbsp</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- /.card-footer -->
...
function batchDelete(){
	...
	//截取字符串
	lids=lids.substring(1);
	if(confirm("是否确定删除？")){
		window.location.href="<%=basePath%>Homework_teacherServlet?method=deletehomework&lids="+lids;
	}
}
</script>
</body>
