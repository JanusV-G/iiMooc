                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">全部考试管理</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <table class="table table-striped projects text-center">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="white-space: nowrap;">
                            	操作
                            	<a class="btn btn-primary btn-sm" href="<%=basePath%>admin/test_add.jsp">
                        ...
                        <tr>
                        	<td>
                        		<input class="chk" name="chk" type="checkbox" value="${test.test_id }"/>
                        	</td>
                            <td>
                            	${test.test_id }
                            </td>
                            ...
                            <td class="project-actions ">
                                <a class="btn btn-primary btn-xs" href="<%=basePath%>ManagerServlet?method=showTestPaperById&id=${test.test_id}&name=${test.test_name }">
                                    <i class="fas fa-folder">
                                    </i>
                                   	查看
                                </a>
                                <a class="btn btn-info btn-xs" href="<%=basePath%>ManagerServlet?method=showTestTotal&id=${test.test_id}">
                                    <i class="fas fa-pencil-alt">
                                    </i>
                                   	修改
                                </a>
                                <a class="btn btn-danger btn-xs" href="<%=basePath%>ManagerServlet?method=deleteTest&id=${test.test_id}">
...
<script type="text/javascript">
	...
	function batchDelete() {
		...
		if(confirm("您是否确定要删除所选考试？")){
			window.location.href="<%=basePath%>ManagerServlet?method=deleteManyTest&uids="+uids;
		}
	}
</script>
</html>
