                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">${sessionScope.login_user.user_name} 老师 , 欢迎您</h3>
                            ...
                            <div class="card-body"> 
                            	<p>${sessionScope.login_user.user_name} 老师您好，欢迎使用imooc后台管理系统。</p>
                                <p>现在时间是<span id="time"></span></p>  
                                <p>当前天气是&nbsp<iframe frameborder="0" scrolling="no" hspace="0" height="25" src="https://i.tianqi.com/?c=code&id=99"></iframe></p>
                            </div>
                            <!-- /.card-body -->
