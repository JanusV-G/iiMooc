                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="<%=basePath%>ManagerServlet?method=updateUser" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <input type="hidden" name="user_id" value="${user.user_id }"/>
                                    <div class="form-group">
                                    <label>用户姓名</label><span id="user_name_msg"></span>
                                    <input name="user_name" id="user_name" type="text" class="form-control" value="${user.user_name }" placeholder="请输入用户姓名 ...">
                                   	</div>
                                    ...
                                    <input type="text" id="user_email" name="user_email" class="form-control" value="${user.user_email }"  placeholder="请输入电子邮箱   例：user@example.com ...">
                                   	</div>
                                    <div class="form-group">
                                                <label>用户类型</label>
                                    ...
                                    <div class="form-group">
                                   		 ...
                                   		 <input type="text" id="user_class" name="user_class" class="form-control" value="${user.user_class }" placeholder="请输入用户班级 ...">
                                   	</div>
                                  	<div class="form-group">
                                    			<label>用户编号</label><span id="student_id_msg"></span>
                                   		 <input type="text" id="student_id" name="student_id" class="form-control" value="${user.student_id }" placeholder="请输入学生学号/教职工工号 ...">
                                   	</div>
                                   	<div class="form-group">
                                    			<label>修改头像</label><span id="user_photo_msg"></span>
                                    			&nbsp&nbsp&nbsp&nbsp
...
$("#user_email").blur(function(){
	...
	$.ajax({
		...
		success:function(data){
			if(data == "true"&&user_email!=now_email){
