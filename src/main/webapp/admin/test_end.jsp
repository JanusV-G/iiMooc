                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">已结束考试管理</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <table class="table table-striped projects text-center">
                        ...
                        <tr>
                            ...
                            <td class="project-actions ">
                                <a class="btn btn-primary btn-xs" href="<%=basePath%>ManagerServlet?method=showTestPaperById&id=${test.test_id}">
                                    <i class="fas fa-folder">
                                    </i>
                                  	查看
                                </a>
