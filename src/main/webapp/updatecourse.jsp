                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">修改课程信息</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <!-- Default box -->
             ...
             <!-- general form elements disabled -->
                        <div class="card card-warning">                      
                            <!-- /.card-header -->
                            <div class="card-body">
                    <form action="<%=basePath%>LessonServlet?method=updateLesson&lesson_id=${lesson.lesson_id }" method="post" enctype="multipart/form-data">
                <label>课程名称：</label>  
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="请输入课程名称" name="lesson_name" value="${lesson.lesson_name }">
                    <div class="input-group-append">
                ...
                <label>课程容量：</label>  
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="请输入课容量（最大学生数量）"" name="students_number" value="${lesson.students_number }">
                    <div class="input-group-append">
                        <div class="input-group-text">
                ...
                <label>视频数目：</label>  
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="网课视频数量（不填默认为0）" name="videos_number" value="${lesson.videos_number }">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-lock"></span>
                        </div>
                ...
                <label>课程进度：</label>  
               <div class="input-group mb-3">
                    <input name="flag" type="radio" value="0" <c:if test="${lesson.flag==0 }">checked="checked"</c:if>/>未结课&nbsp&nbsp
				    <input name="flag" type="radio" value="1" <c:if test="${lesson.flag==1 }">checked="checked"</c:if>/>已结课
                    <div class="input-group-append">
                    </div>
                </div>
                <label>课程封面图片：</label>  
                <div class="input-group mb-3">                         
                    <input type="file" class="form-control" name="lesson_photo" >
                    <input type="hidden" value="${lesson.lesson_photo }" name="oldpic"/>
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-lock"></span>
                        </div>
                ...
                <label>课程描述：</label>  
                 <div class="input-group mb-3">                         
                    <textarea cols="50" rows="5" name="description">${lesson.description }</textarea>
                    <div class="input-group-append">
                    </div>
                </div>
                <label>课程创建时间：</label>  
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="课程创建时间（yyyy-mm-dd）" name="lesson_create_time" value="${lesson.lesson_create_time }">
                    <div class="input-group-append">
                        <div class="input-group-text">
