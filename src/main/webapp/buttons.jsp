...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="<%=basePath%>index3.html" class="brand-link">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<%=basePath%>index2.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Dashboard v2</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<%=basePath%>index3.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Dashboard v3</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<%=basePath%>starter.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Starter Page</p>
                                </a>
                            </li>
                            ...
                            <div class="card-body pad table-responsive">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block btn-default btn-lg">Default
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-default btn-sm">Default
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-default btn-xs">Default
                                            </button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block btn-primary btn-lg">Primary
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-primary btn-sm">Primary
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-primary btn-xs">Primary
                                            </button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block btn-success btn-lg">Success
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-success btn-sm">Success
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-success btn-xs">Success
                                            </button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block btn-danger btn-lg">Danger
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-danger btn-sm">Danger
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-danger btn-xs">Danger
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-danger btn-flat">Danger
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-danger disabled">Danger
                                            </button>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block btn-warning btn-lg">Warning
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-warning btn-sm">Warning
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-warning btn-xs">Warning
                                            </button>
                                        </td>
                                        <td>
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body pad table-responsive">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-primary">Primary
                                            </button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-success">Success
                                            </button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-danger">Danger
                                            </button>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-danger btn-flat">
                                                Danger
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-danger disabled">
                                                Danger
                                            </button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-warning">Warning
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-warning btn-lg">
                                                Warning
                                            </button>
                                        </td>
                                        <td>
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body pad table-responsive">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-block bg-gradient-primary">Primary
                                            </button>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block bg-gradient-primary btn-xs">
                                                Primary
                                            </button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-block bg-gradient-success">Success
                                            </button>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block bg-gradient-success btn-xs">
                                                Success
                                            </button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-block bg-gradient-danger">Danger
                                            </button>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block bg-gradient-danger btn-flat">
                                                Danger
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block bg-gradient-danger disabled">
                                                Danger
                                            </button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-block bg-gradient-warning">Warning
                                            </button>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block bg-gradient-warning btn-sm">
                                                Warning
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block bg-gradient-warning btn-xs">
                                                Warning
                                            </button>
                                        </td>
                                        <td>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-default btn-block btn-sm">.btn-block .btn-sm
                                </button>
                            </div>
                        </div>
                        <!-- /.card -->
