                ...
                <div class="row mb-2">
                    ...
                    <!-- general form elements disabled -->
                        <div class="card card-warning">                      
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<%=basePath%>Homework_teacherServlet?method=updatescore&homework_id=${Homework_student.homework_id }" method="post" enctype="multipart/form-data" >
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <!-- text input -->
                                            <div class="form-group">
                                                <label>作业评分</label>
                                                <input type="text" class="form-control" placeholder="请输入作业分数" name="homework_score" value="${Homework_student.homework_score }">
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label>作业评分描述</label>
                                                <input type="text" class="form-control" placeholder="请输入对作业评分的描述" name="homework_comment" value="${Homework_student.homework_comment }">
                                            </div>
                                        </div>
                                    </div>
                                                      <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-4">
                        <button type="submit" class="btn btn-primary btn-block" alien="center">评分</button>
                    </div>
                    <!-- /.col -->
                </div>                                        
                                </form>
