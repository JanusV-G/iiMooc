                            ...
                            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-7">
                                                <h2 class="lead"><b>${lesson.lesson_name }</b></h2>
                                                    <%--                                                todo: 针对多个任课老师进行修改: --%>
                                                <p class="text-muted text-sm"><b>学生数目: </b> ${lesson.students_number} </p>
                                                <ul class="ml-4 mb-0 fa-ul text-muted">
                                                    <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> 课程简介: ${lesson.description}</li>
                                                    <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> 是否结课：
                                                    	<c:if test="${lesson.flag==0 }">尚未结课</c:if>
	       												<c:if test="${lesson.flag==1 }">已结课</c:if>
                                                    </li>                                         
                                                    <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span>创建时间: ${lesson.lesson_create_time}</li>
                                                </ul>
                                            </div>
                                            <div class="col-5 text-center">
                                                <img src="http://localhost:8080/xmpic/${lesson.lesson_photo }" alt="" class="img-circle img-fluid" width="161px" height="161px">
                                            </div>
                                        </div>
                                    </div>
...
<%--                                            todo: 添加需要传递的信息--%>
                                            <a href="<%=basePath%>LessonServlet?method=updateToShow&lid=${lesson.lesson_id}" class="btn btn-sm bg-teal">
                                                <i class="fas fa-comments"></i>更改信息
                                            </a>
                                            <a href="<%=basePath%>LessonServlet?method=deleteLesson&lname=${lesson.lesson_name }" class="btn btn-sm btn-primary">
                                                <i class="fas fa-user"></i> 删除课程
                                            </a>
                                        </div>
                                    </div>
                                </div>
