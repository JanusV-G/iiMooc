                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">修改视频信息</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <!-- Default box -->
             ...
             <!-- general form elements disabled -->
                        <div class="card card-warning">                      
                            <!-- /.card-header -->
                            <div class="card-body">
                           <form action="<%=basePath%>VideoServlet?method=updateVideo&video_id=${video.video_id}" method="post" enctype="multipart/form-data" >
            <label>视频名称：</label>
            <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="请输入视频名称" name="video_name" value="${video.video_name }">
                ...
                <label>视频描述：</label>  
                 <div class="input-group mb-3">                         
                    <textarea cols="50" rows="5" name="video_description" id="description">${video.video_description}</textarea>
                    <div class="input-group-append">
                    </div>
                </div>
                <label>创建时间：</label>  
                <div class="input-group mb-3">                  
                    <input type="text" class="form-control" placeholder="视频上传时间（yyyy-mm-dd）" name="video_create_time" id="time" value="${video.video_create_time }">
