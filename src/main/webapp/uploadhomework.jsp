                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">新建作业</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <!-- Default box -->
             ...
             <!-- general form elements disabled -->
                        <div class="card card-warning">                      
                            <!-- /.card-header -->
                            <div class="card-body">
                             <form action="<%=basePath%>Homework_teacherServlet?method=addhomework" method="post" enctype="multipart/form-data" >
                                     <label>作业名称：</label>  
                			       <div class="input-group mb-3">
                  			   <input type="text" class="form-control" placeholder="请输入作业名称" name="homework_name" id="homework_name">
                   			<div class="input-group-append">
                     	...
                     	<div class="input-group-text">
                         	 <span class="fas fa-envelope"></span>
               						  ...
               						  <label>作业描述：</label>  
                			       <div class="input-group mb-3">
                  			    <input type="text" class="form-control" placeholder="请输入对作业的描述" name="homework_description">
                   			<div class="input-group-append">
                     	<div class="input-group-text">
                         	 <span class="fas fa-envelope"></span>
                       			 </div>
               						    ...
               						    <label>创建时间：</label>  
                			       <div class="input-group mb-3">
                  			   <input type="text" class="form-control" placeholder="作业创建（yyyy-mm-dd ）" name="homework_create_time">
                   			<div class="input-group-append">
                     	<div class="input-group-text">
                         	 <span class="fas fa-envelope"></span>
                       			 </div>
