                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">新建考试</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <!-- Default box -->
             ...
             <!-- general form elements disabled -->
                        <div class="card card-warning">                      
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<%=basePath%>Test_totalServlet?method=addTesk_Total" method="post" enctype="multipart/form-data" >
                             <label>考试名称：</label>
            <div class="input-group mb-3">
                   <input type="text" class="form-control" placeholder="请输入考试名称" name="test_name" >
                ...
                <label>考试密码：</label>  
                <div class="input-group mb-3">                         
                     <input type="text" class="form-control" placeholder="请输入考试密码" name="test_password" >
                ...
                <label>开始时间：</label>  
                 <div class="input-group mb-3">                         
                      <input type="text" class="form-control" placeholder="请输入开始时间" name="begin_time" >
                    <div class="input-group-append">
                    </div>
                </div>
                <label>结束时间：</label>  
                <div class="input-group mb-3">                  
                    <input type="text" class="form-control" placeholder="考试结束时间（yyyy-mm-dd ）" name="end_time">
