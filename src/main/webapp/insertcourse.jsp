...
<head>
    ...
    <script language="javascript" type="text/javascript" src="<%=basePath %>plugins/WdatePicker.js"></script>
</head>
            ...
            <!-- Default box -->
             ...
             <!-- general form elements disabled -->
                        <div class="card card-warning">                      
                            <!-- /.card-header -->
                            <div class="card-body">
           <form action="<%=basePath%>LessonServlet?method=addLesson" method="post" enctype="multipart/form-data" >
                <label>课程名称：</label>  
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="请输入课程名称" name="lesson_name" id="lesson_name">
                    <span id="lesson_name_msg"></span>
                    <div class="input-group-append">
                ...
                <label>课程容量：</label>  
                <div class="input-group mb-3">               
                    <input type="text" class="form-control" placeholder="请输入课容量（最大学生数量）" name="students_number" id="students_number">
                ...
                <label>课程封面图片：</label>  
                <div class="input-group mb-3">                         
                    <input type="file" class="form-control" name="lesson_photo" id="lesson_photo">
                ...
                <label>课程创建时间：</label>  
                <div class="input-group mb-3">                    
                    <input type="text" class="form-control" placeholder="课程创建时间（yyyy-mm-dd）" name="lesson_create_time" id="time">
