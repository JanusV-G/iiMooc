                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label>题目序号</label>
                                                <input type="text" class="form-control" placeholder="请输入题目序号">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label>题目分值</label>
                                                <input type="text" class="form-control" placeholder="请输入题目分值">
                                            </div>
                                        </div>
                                    </div>
                            </div>
     ...
     <div class="container-fluid">
        ...
        <section class="content">
           ...
           <div class="row">
             <div class="col-sm-6">
                 <div class="form-group">
                      <button type="submit" class="btn btn-primary btn-block" alien="center">保存并编辑下一题</button>              
                 </div>
             </div>
          </div>        
      </div>
