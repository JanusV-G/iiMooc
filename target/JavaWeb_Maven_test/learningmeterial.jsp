              ...
              <button type="button" class="btn btn-block btn-success" onclick="batchDelete()">
    		   <ion-icon name="trash-outline"></ion-icon>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <c:forEach items="${Learning_materials }" var="Learning_materials">              
                  	<tr>
                  	 <th><input name="chk" type="checkbox" value="${Learning_materials.lm_id }"  id="chk" class="chk"/></th>
                    <td>${Learning_materials.lm_name}</td>
                    <td>${Learning_materials.lesson_name }</td>
                    <td><a href="http://localhost:8080/xmpic/${Learning_materials.lm_file }"/>预览</a></td>
                    <td>${Learning_materials.lm_description }</td>
                    <td>${Learning_materials.lm_create_time }</td>
                    <td>
                    	<a href="<%=basePath%>Learning_materialsServlet?method=updateToShow&lm_name=${Learning_materials.lm_name }">修改</a>
                    </td>
                  </tr>
                  </c:forEach>  
                 </tbody>
...
function batchDelete(){
	...
	if(confirm("是否确定删除？")){
		window.location.href="<%=basePath%>Learning_materialsServlet?method=deleteLessonmaterial&lids="+lids;
	}
}
</script>
</body>
