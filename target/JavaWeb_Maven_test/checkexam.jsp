                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">试卷批改</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="card card-solid">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <c:forEach items="${Test_paper }" var="Test_paper"> 
                  	<tr>
                    <td>${Test_paper.test_id }</td>
                     <td>${Test_paper.problem_number }</td>
                    <td>${Test_paper.student_name }</td>
                    <td>${Test_paper.string_answer }</td>
                    <td><a href="<%=picPath %>${Test_paper.pic_answer }"/>图片答案</a></td>
                    <td>
                    <c:if test="${Test_paper.test_score==0 }"></c:if>
                     <c:if test="${Test_paper.test_score>0 }">${Test_paper.test_score }</c:if>                  
                    </td>
                    <td>${Test_paper.test_comment }</td>
                    <td>
                    <a href="<%=basePath%>Homework_teacherServlet?method=updateToShowscore2&student_name=${Test_paper.student_name }">评分评语</a>
                    </td>
                  </tr>
                  </c:forEach> 
                 </tbody>
