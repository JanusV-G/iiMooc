                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">章节</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <c:forEach items="${videoList }" var="video">
                            <div class="card card-primary" onclick="window.location.href='StudentServlet?method=studentLearningVideoDetail&videoID=${video.video_id}'">
                            ...
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item"><a class="nav-link active" href="#settings"
                                                            data-toggle="tab">${videoNow.video_name}</a></li>
                                </ul>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="active tab-pane" id="settings">
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <video src="<%=videosPath%>${videoNow.video_file}" controls></video>
                                        </div>
                                    </div>
                                    <!-- /.tab-pane -->
                                </div>
