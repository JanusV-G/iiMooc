                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">我的试题</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <c:forEach items="${tests }" var="test">              
                  	<tr>
                  	 <th><input name="chk" type="checkbox" value="${test.test_id }"  id="chk" class="chk"/></th>
                    <td>${test.test_name }</td>
                    <td>${test.lesson_name }</td>
                    <td>${test.test_password }</td>
                    <td>${test.begin_time }</td>
                    <td>${test.end_time }</td>
                    <td>
                    <a href="<%=basePath%>Test_totalServlet?method=updateToShow&tid=${test.test_id}">修改信息&nbsp&nbsp</a>
                    <a href="<%=basePath%>Test_totalServlet?method=findTesk_TotalById&tid=${test.test_id}">编辑试题&nbsp&nbsp</a>
                    <a href="<%=basePath%>TestServlet?method=findTest&tid=${test.test_id}">查看试题</a>
                    </td>
                  </tr>
                  </c:forEach>  
                 </tbody>
                ...
                <div class="card-footer">
                    <nav aria-label="Contacts Page Navigation">
                        <ul class="pagination justify-content-center m-0">
                            <ul class="pagination justify-content-center m-0">
                            <li class="page-item active"><a href="<%=basePath%>Test_totalServlet?method=findTesk_Total&currentPage=1">首页&nbsp&nbsp</a></li>
                            <li class="page-item"><a href="<%=basePath%>Test_totalServlet?method=findTesk_Total&currentPage=${tool.prePage }">上一页&nbsp&nbsp</a></li>
                            <li class="page-item"><a href="<%=basePath%>Test_totalServlet?method=findTesk_Total&currentPage=${tool.nextPage }">下一页&nbsp&nbsp</a></li>
                            <li class="page-item"><a href="<%=basePath%>Test_totalServlet?method=findTesk_Total&currentPage=${tool.totalPages }">尾页&nbsp&nbsp</a></li>                 
                        </ul>
                    </nav>
                </div>
                <!-- /.card-footer -->
...
//全选全部选
  ...
  function batchDelete(){
  	...
  	if(confirm("是否确定删除？")){
  		window.location.href="<%=basePath%>Test_totalServlet?method=deleteTesk_Total&tids="+tids;
  	}
  }
</script>
</body>
