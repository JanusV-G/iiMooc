                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="<%=basePath%>ManagerServlet?method=addLesson" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group">
                                    <label>课程名称</label><span id="lesson_name_msg"></span>
                                    <input name="lesson_name" id="lesson_name" type="text" class="form-control" placeholder="请输入课程名称 ...">
                                   	</div>
									<div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <input name="students_number" id="students_number" type="text" class="form-control" placeholder="请输入学生数量 ...">
                                   	</div>
                                    
                                    <div class="form-group">
                                    			<label>上传课程封面图片</label><span id="lesson_photo_msg"></span>
                                    			&nbsp&nbsp&nbsp&nbsp
                                    ...
                                    <input name="description" id="description" type="text" class="form-control" placeholder="请输入课程描述 ...">
                                   	</div>
