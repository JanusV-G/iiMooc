                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="<%=basePath%>ManagerServlet?method=edictTestTotal&id=${test.test_id }" method="post" onsubmit="return subcheck()">
                                <div class="card-body">
...
<script>
	var test_name_flag = true;
	var lesson_name_flag = true;
	var teacher_name_flag = true;
	var test_password_flag = true;
	var begin_time = true;
	var end_time = true;
