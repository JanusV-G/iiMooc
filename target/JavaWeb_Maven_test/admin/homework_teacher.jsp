                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">全部作业管理</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card-body p-0">
                    <table class="table table-striped projects text-center">
                        ...
                        <tr>
                            ...
                            <td>
                            	${homework.homework_create_time }
                            </td>
                            <td  >
                            	${homework.homework_description }
                            </td>
                            <td class="project-actions ">
                                <a class="btn btn-danger btn-xs" href="<%=basePath%>ManagerServlet?method=deleteHomework&homework_id=${homework.homework_id}">
...
<script type="text/javascript">
	...
	function batchDelete() {
		...
		if(confirm("您是否确定要删除所选学习资料？")){
			window.location.href="<%=basePath%>ManagerServlet?method=deleteManyHomeworkTeacher&uids="+uids;
		}
	}
</script>
</html>
