                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">网课管理</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card-body p-0">
                    <table class="table table-striped projects">
                        ...
                        <tr align="center" >
                            ...
                            <th>操作 &nbsp
                            <font color="white">
                            <a class="btn btn-primary btn-sm" href="<%=basePath%>ManagerServlet?method=findAllData"><i class="fas fa-folder">&nbsp添加</i>
                           	</a>
                        ...
                        <tr align="center" >
                        <td><input class="chk" name="chk" type="checkbox" value="${video.video_id }"/></td>
                            <td>${video.video_id }</td>
                            <td><a>${video.video_name }</a></td>
                            <td>${video.upload_user_name }</td>
                            <td>${video.lesson_name }</td>
                            <td>${video.video_description }</td>
                            <td><fmt:formatDate value="${video.video_create_time }" pattern="yyyy-MM-dd" /></td>
                            <%-- <td><input type="hidden" name="video_file" value="${video.video_file }"/></td> --%>
                            <td class="project-actions">
                                <%-- <a class="btn btn-info btn-sm" href="<%=basePath %>ManagerServlet?method=updateVideoToShow&video_id=${video.video_id }"> --%>
                                <a class="btn btn-info btn-sm" href="<%=videosPath %>${video.video_file }">
...
<script type="text/javascript">
	...
	function batchDelete() {
		...
		if(confirm("您是否确定要删除所选视频信息？")){
			window.location.href="<%=basePath%>ManagerServlet?method=deleteManyVideos&uids="+uids;
		}
	}
</script>
<!-- Bootstrap 4 -->
