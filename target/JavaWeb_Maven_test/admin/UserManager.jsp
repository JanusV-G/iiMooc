                ...
                <div class="card-body p-0">
                    <table class="table table-striped projects">
                        ...
                        <td><input class="chk" name="chk" type="checkbox" value="${user.user_id }"/></td>
                            ...
                            <td>
								<c:if test="${user.user_type == 0}">管理员</c:if>
			        			<c:if test="${user.user_type == 1}">教师</c:if>
			        			<c:if test="${user.user_type == 2}">学生</c:if>
							</td>
                            <td>${user.user_class }</td>
                            <td>${user.user_email }</td>
                            <td>
			       				<img src="<%=picPath%>${user.user_photo }" width="40px" height="40px"/>
			       			</td>
