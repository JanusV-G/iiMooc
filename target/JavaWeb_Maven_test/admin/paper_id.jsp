                    ...
                    <table class="table table-striped projects text-center">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="white-space: nowrap;">
                            	操作
                            	<a class="btn btn-primary btn-sm" href="<%=basePath%>ManagerServlet?method=transmitTestid&test_id=${test_id }">
                                    <i class="fas fa-folder"></i>
                                   	添加
                                </a>
                                <font color="white">
                            	 <a class="btn btn-danger btn-sm " onclick="batchDelete()">
                            		<i class="fas fa-trash">删除</i></a>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr>
                        	<td>
                        		<input class="chk" name="chk" type="checkbox" value="${paper.problem_id }"/>
                        	</td>
                        	<td>
                            	${paper.problem_id }
                            </td>
                            ...
                            <td>
                            	${paper.problem_number }
                            </td>
                            <td>
								${paper.problem_type }
                            </td>
                            <td class="project_progress">
                            	<img src="<%=picPath%>${paper.problem_photo }" class="pimg" width="30px" height="30px"/>
                            </td>
                            <td class="project-state">
                            	${paper.problem_answer }
                            </td>
                            <td>
                            	${paper.problem_score }
                            </td>
                            <td class="project-actions ">
                                <a class="btn btn-primary btn-xs" href="<%=basePath%>ManagerServlet?method=viewAnswerByProblem&test_id=${paper.test_id}&problem_number=${paper.problem_number }">
                                    <i class="fas fa-folder">
                                    </i>
                                   	查看
                                </a>
                                <a class="btn btn-info btn-xs" href="<%=basePath%>ManagerServlet?method=edictProblemtoshow&test_id=${paper.test_id}&problem_number=${paper.problem_number }">
                                    <i class="fas fa-pencil-alt">
                                    </i>
                                   	修改
                                </a>
                                <a class="btn btn-danger btn-xs" href="<%=basePath%>ManagerServlet?method=deleteProblem&test_id=${paper.test_id}&problem_number=${paper.problem_number }">
...
<script type="text/javascript">
	...
	function batchDelete() {
		...
		if(confirm("您是否确定要删除所选试卷？")){
			window.location.href="<%=basePath%>ManagerServlet?method=deleteManyProblem&uids="+uids;
		}
	}
</script>
</html>
