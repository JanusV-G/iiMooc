                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">学习资料管理</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <table class="table table-striped projects text-center">
                        ...
                        <tr>
                        	<td>
                        	<input class="chk" name="chk" type="checkbox" value="${lm.lm_id }"/>
                        	</td>
                            <td>
                            	${lm.lm_id }
                            </td>
                            ...
                            <td class="project-actions ">
                                <a class="btn btn-danger btn-xs" href="<%=basePath%>ManagerServlet?method=deleteLm&lm_id=${lm.lm_id}">
...
<script type="text/javascript">
	...
	function batchDelete() {
		...
		if(confirm("您是否确定要删除所选学习资料？")){
			window.location.href="<%=basePath%>ManagerServlet?method=deleteManyLm&uids="+uids;
		}
	}
</script>
</html>
