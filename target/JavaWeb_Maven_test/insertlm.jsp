       ...
       <!-- Content Header (Page header) -->
        <section class="content-header">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">上传资料</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
         ...
         <div class="card card-warning">                      
          <div class="card-body">
            <form action="<%=basePath%>Learning_materialsServlet?method=addMaterial" method="post" enctype="multipart/form-data" >
               <label>资料名称：</label>  
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="请输入资料名称" name="Lm_name" id="Lm_name">
                    <div class="input-group-append">
                ...
                <label>资料上传：</label>  
                <div class="input-group mb-3">                         
                    <input type="file" class="form-control" name="Lm_file" id="Lm_file">
                    <div class="input-group-append">
                        <div class="input-group-text">
                ...
                <label>资料描述：</label>  
                 <div class="input-group mb-3">                         
                    <textarea cols="50" rows="5" name="Lm_description" id="Lm_description"></textarea>
                    <div class="input-group-append">
                    </div>
                </div>
            	 <label>上传时间 ：</label>     
                <div class="input-group mb-3">                    
                    <input type="text" class="form-control" placeholder="资料上传时间（yyyy-mm-dd）" name="Lm_create_time" id="Lm_create_time">
                    <div class="input-group-append">
                        <div class="input-group-text">
...
<!-- AdminLTE App -->
<script src="<%=basePath%>dist/js/adminlte.min.js">
</script>
</body>
</html>
