        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="StudentServlet?method=showAllLesson" class="nav-link active">
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                <h2 class="lead"><b>${Lesson.lesson_name}</b></h2>
                                                    <%--                                                todo: 针对多个任课老师进行修改: --%>
                                                <p class="text-muted text-sm"><b>任课教师: </b> ${Lesson.teacher_name} </p>
                                                <ul class="ml-4 mb-0 fa-ul text-muted">
                                                    <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> 课程简介: ${Lesson.description}</li>
                                                    <br/>
                                                    <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> 创建时间: ${Lesson.lesson_create_time}</li>
                                                </ul>
                                            </div>
                                            <div class="col-5 text-center">
                                                <img src="<%=picPath%>${Lesson.lesson_photo}" alt="" class="img-circle img-fluid" width="161px" height="161px">
                                            </div>
                                        </div>
                                    </div>
...
<%--                                            todo: 添加需要传递的信息--%>
                                            <a href="StudentServlet?method=showLearningMain&lessonID=${Lesson.lesson_id}" class="btn btn-sm bg-teal">
                                                <i class="fas fa-comments"></i>进入课程
                                            </a>
                                            <a href="LessonServlet?method=lessonDetail&lid=${Lesson.lesson_id}" class="btn btn-sm btn-primary">
