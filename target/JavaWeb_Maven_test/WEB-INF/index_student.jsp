            ...
            <div class="card card-solid">
                <div class="card-body pb-0">
                    <div class="row d-flex align-items-stretch">
                        ...
                        <c:forEach items="${activeLessonList}" var="activeLesson">
<%--                todo: 添加课程点击事件, 跳转到学习界面--%>
                            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-7">
                                                <h2 class="lead"><b>${activeLesson.lesson_name}</b></h2>
                                                    <%--                                                todo: 针对多个任课老师进行修改: --%>
                                                <p class="text-muted text-sm"><b>任课教师: </b> ${activeLesson.teacher_name} </p>
                                                <ul class="ml-4 mb-0 fa-ul text-muted">
                                                    <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> 课程简介: ${activeLesson.description}</li>
                                                    <br/>
                                                    <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> 创建时间: ${activeLesson.lesson_create_time}</li>
                                                </ul>
                                            </div>
                                            <div class="col-5 text-center">
                                                <img src="<%=picPath%>${activeLesson.lesson_photo}" alt="" class="img-circle img-fluid" width="161px" height="161px">
                                            </div>
                                        </div>
                                    </div>
...
<%--                                            todo: 添加需要传递的信息--%>
                                            <a href="StudentServlet?method=showLearningMain&lessonID=${activeLesson.lesson_id}" class="btn btn-sm bg-teal">
                                                <i class="fas fa-comments"></i>进入课程
                                            </a>
                                            <a href="LessonServlet?method=lessonDetail&lid=${activeLesson.lesson_id}" class="btn btn-sm btn-primary">
                            ...
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-center">
                                            <img src="<%=basePath%>dist/img/user1-128x128.jpg" alt="" class="img-circle img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                            ...
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-center">
                                            <img src="<%=basePath%>dist/img/user2-160x160.jpg" alt="" class="img-circle img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
