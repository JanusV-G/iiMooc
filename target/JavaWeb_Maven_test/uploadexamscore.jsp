                ...
                <div class="row mb-2">
                    ...
                    <!-- general form elements disabled -->
                        <div class="card card-warning">                      
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<%=basePath%>Homework_teacherServlet?method=updateexamscore&student_name=${Test_paper.student_name }" method="post" enctype="multipart/form-data" >
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <!-- text input -->
                                            <div class="form-group">
                                                <label>作业评分</label>
                                                <input type="text" class="form-control" placeholder="请输入作业分数" name="test_score" value="${Test_paper.test_score }">
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label>作业评分描述</label>
                                                <input type="text" class="form-control" placeholder="请输入对作业评分的描述" name="test_comment" value="${Test_paper.test_comment }">
                                            </div>
                                        </div>
                                    </div>
                                                      <div class="row">
