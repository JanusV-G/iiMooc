    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">作业批改</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <c:forEach items="${Homework_student }" var="Homework_student"> 
                  	<tr>
                    <td>${Homework_student.homework_id }</td>
                     <td>${Homework_student.student_name }</td>
                    <td>${Homework_student.homework_name }</td>
                    <td><a href="http://localhost:8080/image/${Homework_student.submit_file }"/>查看文件</a></td>
                    <td>
                   <c:if test="${Homework_student.homework_score==0 }">尚未批改</c:if>
                    <c:if test="${Homework_student.homework_comment>0 }">${Homework_student.homework_score }</c:if>
                    </td>
                    <td>${Homework_student.homework_comment }</td>
                    <td>
                    <a href="<%=basePath%>Homework_teacherServlet?method=updateToShowscore&studentwork_id=${Homework_student.homework_id }">评分评语</a>
                    </td>
                  </tr>
                  </c:forEach> 
                 </tbody>
                ...
                <div class="card-footer">
                    <nav aria-label="Contacts Page Navigation">
                        <ul class="pagination justify-content-center m-0">
                            <ul class="pagination justify-content-center m-0">
                            <li class="page-item active"><a href="<%=basePath%>Homework_teacherServlet?method=findstuhomeworkbytname&currentPage=1">首页&nbsp&nbsp</a></li>
                            <li class="page-item"><a href="<%=basePath%>Homework_teacherServlet?method=findstuhomeworkbytname&currentPage=${tool.prePage }">上一页&nbsp&nbsp</a></li>
                            <li class="page-item"><a href="<%=basePath%>Homework_teacherServlet?method=findstuhomeworkbytname&currentPage=${tool.nextPage }">下一页&nbsp&nbsp</a></li>
                            <li class="page-item"><a href="<%=basePath%>Homework_teacherServlet?method=findstuhomeworkbytname&currentPage=${tool.totalPages }">尾页</a></li>                 
                        </ul>
                    </nav>
                </div>
                <!-- /.card-footer -->
