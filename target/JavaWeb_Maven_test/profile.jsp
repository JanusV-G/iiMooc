                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <b>Phone</b> <a class="float-right">${sessionScope.login_user.user_email}</a>
                                    </li>
<%--                                    <li class="list-group-item">--%>
                        ...
                        <div class="card">
                          ...
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                                        ...
                                        <div class="post">
                                            <div class="user-block">
                                                <img class="img-circle img-bordered-sm"
                                                     src="<%=basePath%>dist/img/user6-128x128.jpg" alt="User Image">
                                                <span class="username">
                          <a href="#">Adam Jones</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-6">
                                                    <img class="img-fluid" src="<%=basePath%>dist/img/photo1.png"
                                                         alt="Photo">
                                                </div>
                                                <!-- /.col -->
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <img class="img-fluid mb-3"
                                                                 src="<%=basePath%>dist/img/photo2.png" alt="Photo">
                                                            <img class="img-fluid"
                                                                 src="<%=basePath%>dist/img/photo3.jpg" alt="Photo">
                                                        </div>
                                                        <!-- /.col -->
                                                        <div class="col-sm-6">
                                                            <img class="img-fluid mb-3"
                                                                 src="<%=basePath%>dist/img/photo4.jpg" alt="Photo">
                                                            <img class="img-fluid"
                                                                 src="<%=basePath%>dist/img/photo1.png" alt="Photo">
                                                        </div>
                                                        <!-- /.col -->
                                                    </div>
                                                    <!-- /.row -->
